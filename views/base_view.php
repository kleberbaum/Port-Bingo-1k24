...
<body>
<header>
    <h1 class="title"><span class="firstl">P</span>ORT-<span class="firstl">B</span>INGO-<span class="firstl">10</span>24</h1>
</header>
<article>
    <section>
...
<footer>
    <label for="cmd" id="cmd">Toko@Alpha-PC:~$&nbsp<input type="text" id="cli" name="cli" autofocus>[^]</label>
    <nav>
